...
class CafeKioskTest {
    ...
    void addZeroBeverages(){
        ...
        //0잔을 넣었을때 IllegalArgumentException이 발생할 것이다.
    ...
    void createOrderWithCurrentTime(){
        ...
        Order order = cafeKiosk.createOrder(LocalDateTime.of(2023, 10, 17, 10, 0));
    ...
    void createOrderNotOpenTime(){
        ...
        assertThatThrownBy(() -> cafeKiosk.createOrder(LocalDateTime.of(2023, 10, 17, 9, 59)))
                .isInstanceOf(IllegalArgumentException.class)
